<head>
    ...
    <title>Rently - Admin Dashboard</title>
    <link rel="icon" type="image/svg+xml" href="{{ asset('assets-admin/logo/logo-icon.svg?v=2') }}" sizes="16x16">
    <!-- remix icon font css  -->
    ...
    <!-- prism css -->
    <link rel="stylesheet" href="{{ asset('assets-admin/css/lib/prism.css') }}">
    <!-- file upload css -->
    <link rel="stylesheet" href="{{ asset('assets-admin/css/lib/file-upload.css') }}">
